...
exports.jioPGCallback = async (req, res) => {
  ...
  // ✅ Respond immediately to PayPhi to prevent timeout
  res.status(200).send("OK");
  ...
  // Optional render after status check (won't be seen by PayPhi)
  // If user is redirected to this page in future
  res.render("paymentResult", {
    merchantTxnNo,
    amount,
    responseCode,
